...
class Tx_Palm_Controller_DemoController extends Tx_Extbase_MVC_Controller_ActionController {
	...
	public function indexAction() {
		...
		$accommodationRepository = $this->objectManager->get('Tx_Traveldb_Domain_Repository_AccommodationRepository');
		$accommodation = $accommodationRepository->findByUid(10);
