 ...
 */
class Tx_Palm_Reflection_ObjectAccess {
	...
	static public function getPropertyPath($subject, $propertyPath) {
		...
		foreach ($propertyPathSegments as $pathSegment) {
			if (is_numeric($pathSegment) && $subject instanceof Tx_Extbase_Persistence_ObjectStorage) {
				/** @var Tx_Extbase_Persistence_ObjectStorage $subject */
